...
[results, CT, CP, Uinf, Radius, twist_distribution, chord_distribution] = BEM.ExecuteBEM(PR, WT, N, plotter, mode)
...
fig1 = plt.figure(figsize=(12, 6))
plt.title(r'Torque, non-dimensioned by $\frac{1}{2} \rho U_\infty^2 R^2$', fontsize=20)
plt.plot(results[:,2], twist_distribution[1:twist_distribution.size], 'b-', label=r'$twist$')
plt.grid()
plt.xlabel('r/R', fontsize=20)
plt.ylabel(r'$C_q$ [N]', fontsize=20)
plt.legend(fontsize=20)
...
fig1 = plt.figure(figsize=(12, 6))
plt.title(r'Torque, non-dimensioned by $\frac{1}{2} \rho U_\infty^2 R^2$', fontsize=20)
plt.plot(results[:,2], chord_distribution[1:twist_distribution.size], 'b-', label=r'$chord$')
plt.grid()
plt.xlabel('r/R', fontsize=20)
plt.ylabel(r'$C_q$ [N]', fontsize=20)
plt.legend(fontsize=20)
